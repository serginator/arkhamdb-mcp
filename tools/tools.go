...
type ArkhamDBTool interface {
	...
	SearchCardsAdvanced(chapter int, cycleCode string, factionCode string, typeCode string, xpMin int, xpMax int, costMin int, costMax int, traits []string, tags []string, textSearch string, maxResults int) (string, error)
	...
	BuildStarterDeck(investigatorCode string, chapter int, cycleCodes []string, xpBudget int, strategy string, tabooOverride *bool) (string, error)
	...
	ValidateDeck(deckID *int, decklistID *int, tabooOverride *bool) (string, error)
